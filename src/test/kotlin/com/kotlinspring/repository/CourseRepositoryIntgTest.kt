...
//@SpringBootTest(classes = [CourseCatalogServiceApplication::class])
@DataJpaTest
@ActiveProfiles("test")
//@Import(CourseCatalogServiceApplication::class)
...
class CourseRepositoryIntgTest : PostgresSQLContainerInitializer(){
    ...
    @ParameterizedTest //run multiple tests in a single test
