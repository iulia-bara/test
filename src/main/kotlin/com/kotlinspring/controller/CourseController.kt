...
class CourseController(val courseService: CourseService) {
    ...
    //required = false : "This query parameter is optional.If it’s not present, just set the variable to null (or default value).”


    //nullable because course_name is an optional filed
